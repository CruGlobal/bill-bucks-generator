...
class Regexp::Expression::Group::Passive < ::Regexp::Expression::Group::Base; end
...
class Regexp::Parser::ParserError < ::StandardError; end
...
class Regexp::Scanner::ScannerError < ::StandardError; end
...
class Regexp::Syntax::SyntaxError < ::StandardError; end

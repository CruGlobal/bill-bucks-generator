...
Standard::Cli::FAILURE_STATUS_CODE = T.let(T.unsafe(nil), Integer)
Standard::Cli::SUCCESS_STATUS_CODE = T.let(T.unsafe(nil), Integer)
...
Standard::Formatter::CALL_TO_ACTION_MESSAGE = T.let(T.unsafe(nil), String)

...
module ActiveRecord::AdvisoryLockBase::GeneratedAssociationMethods; end
module ActiveRecord::AdvisoryLockBase::GeneratedAttributeMethods; end
...
class ActiveRecord::PredicateBuilder
  ...
  def resolve_column_aliases(*_arg0, &_arg1); end
...
class ActiveRecord::QueryCanceled < ::ActiveRecord::StatementInvalid; end
...
class ActiveRecord::Reflection::PolymorphicReflection < ::ActiveRecord::Reflection::AbstractReflection
  ...
  def constraints; end
  def get_join_keys(*_arg0, &_arg1); end
  def join_scopes(table, predicate_builder); end
...
class ActiveRecord::StatementTimeout < ::ActiveRecord::StatementInvalid; end
...
class ActiveRecord::TableMetadata
  ...
  def association_foreign_key(*_arg0, &_arg1); end
  def association_foreign_type(*_arg0, &_arg1); end
  def association_join_foreign_key(*_arg0, &_arg1); end
  def association_join_primary_key(*_arg0, &_arg1); end
...
class Arel::Nodes::Grouping < ::Arel::Nodes::Unary; end
...
class Arel::Nodes::IsDistinctFrom < ::Arel::Nodes::Equality; end
class Arel::Nodes::IsNotDistinctFrom < ::Arel::Nodes::Equality; end

...
ENV["RAILS_ENV"] ||= "test"
require File.expand_path("../../config/environment", __FILE__) # Prevent database truncation if the environment is production
...
ActiveRecord::Migration.maintain_test_schema! if Rails.version < "8.0"
